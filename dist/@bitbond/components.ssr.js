...
var __vue_render__$3 = function __vue_render__() {
  ...
  }, [_vm._ssrNode("<div data-v-30dc295a>", "</div>", [_vm.label ? _vm._ssrNode("<label" + _vm._ssrAttr("for", _vm.name) + _vm._ssrClass(null, _vm.labelClasses) + " data-v-30dc295a>", "</label>", [_vm._ssrNode(_vm._ssrEscape(_vm._s(_vm.label) + "\n      ") + (_vm.required ? "<span data-v-30dc295a>*</span>" : "<!---->"))], 2) : _vm._ssrNode("<label" + _vm._ssrAttr("for", _vm.name) + _vm._ssrClass(null, _vm.labelClasses) + " data-v-30dc295a>", "</label>", [_vm._t("label")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"flex\" data-v-30dc295a>", "</div>", [_vm.prepend ? _vm._ssrNode("<div" + _vm._ssrClass(null, ["prepend rounded-l"].concat(_vm.prependClasses)) + " data-v-30dc295a>", "</div>", [_vm._ssrNode("<div class=\"flex items-center justify-center h-full\" data-v-30dc295a>", "</div>", [_vm._t("prepend")], 2)]) : _vm._e(), _vm._ssrNode(" <div class=\"flex-1\" data-v-30dc295a><input" + _vm._ssrAttr("type", _vm.type) + _vm._ssrAttr("name", _vm.name) + _vm._ssrAttr("disabled", _vm.disabled) + _vm._ssrAttr("value", _vm.value) + _vm._ssrAttrs(_vm.$attrs) + _vm._ssrClass(null, ['w-full leading-none'].concat(_vm.inputClasses)) + " data-v-30dc295a></div> "), _vm.append ? _vm._ssrNode("<div" + _vm._ssrClass(null, ["append rounded-r"].concat(_vm.appendClasses)) + " data-v-30dc295a>", "</div>", [_vm._ssrNode("<div class=\"flex items-center justify-center h-full\" data-v-30dc295a>", "</div>", [_vm._t("append")], 2)]) : _vm._e()], 2)], 2), _vm._ssrNode(" <div" + _vm._ssrClass(null, ['relative'].concat(_vm.labelClasses)) + " data-v-30dc295a><div class=\"text-red-500 text-sm absolute\"" + _vm._ssrStyle(null, null, {
    display: _vm.hasError ? '' : 'none'
  }) + " data-v-30dc295a>" + _vm._ssrEscape("\n      " + _vm._s(_vm.errors[0]) + "\n    ") + "</div> <div class=\"text-gray-500 text-sm absolute\"" + _vm._ssrStyle(null, null, {
...
var __vue_inject_styles__$3 = function __vue_inject_styles__(inject) {
  if (!inject) return;
  inject("data-v-30dc295a_0", {
    source: ".append[data-v-30dc295a],.prepend[data-v-30dc295a],input[data-v-30dc295a]{transition:all .3s ease;-webkit-appearance:none;-moz-appearance:none;appearance:none}input[data-v-30dc295a]:focus{outline:0}",
    map: undefined,
    media: undefined
  });
};
...
var __vue_scope_id__$3 = "data-v-30dc295a";
/* module identifier */

var __vue_module_identifier__$3 = "data-v-30dc295a";
/* functional template */
...
}, __vue_inject_styles__$9, __vue_script__$9, __vue_scope_id__$9, __vue_is_functional_template__$9, __vue_module_identifier__$9, false, undefined, undefined, undefined);/* eslint-disable import/prefer-default-export */var components=/*#__PURE__*/Object.freeze({__proto__:null,bbIcon: __vue_component__,bbForm: __vue_component__$1,bbBtn: __vue_component__$2,bbTextInput: __vue_component__$3,bbSelectInput: __vue_component__$4,bbTextarea: __vue_component__$5,bbCopyBtn: __vue_component__$6,bbLoadingIcon: __vue_component__$7,bbChip: __vue_component__$8,bbSnackbar: __vue_component__$9});var install = function installComponents(Vue) {
...
exports.bbBtn=__vue_component__$2;exports.bbChip=__vue_component__$8;exports.bbCopyBtn=__vue_component__$6;exports.bbForm=__vue_component__$1;exports.bbIcon=__vue_component__;exports.bbLoadingIcon=__vue_component__$7;exports.bbSelectInput=__vue_component__$4;exports.bbSnackbar=__vue_component__$9;exports.bbTextInput=__vue_component__$3;exports.bbTextarea=__vue_component__$5;exports.default=plugin;